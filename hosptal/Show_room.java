...
public class Show_room extends javax.swing.JInternalFrame {
    ...
    private void query() {
        ...
        try {
            ...
            String SQLa = "Select room_no,room_type,charges,curdate() from room where status='" + ("Y") + "'";
